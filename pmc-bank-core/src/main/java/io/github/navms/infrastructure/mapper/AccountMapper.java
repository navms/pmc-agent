...
public interface AccountMapper extends BaseMapper<AccountDO> {
     ...
     * @return 聚合行，金额为余额合计
     */
    List<AggregateRowDO> aggregate(@Param("tenantId") String tenantId, @Param("accountNo") String accountNo,
                                   @Param("status") String status, @Param("groupExpr") String groupExpr, @Param("limit") int limit);
}
