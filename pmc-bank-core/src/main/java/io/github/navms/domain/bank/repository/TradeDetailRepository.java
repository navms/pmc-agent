...
public interface TradeDetailRepository {
     ...
     * @return 交易明细列表
     */
    List<TradeDetail> query(String tenantId, String accountNo, String tradeDetailNo, String receiptNo,
     ...
     * @param startDate    交易日起，可空
     * @param endDate      交易日止，可空
     * @param aggregateSql 聚合SQL，可空
     * @param maxRows      最大分组数
     * @return 聚合结果
     */
    List<AggregateRow> aggregate(String tenantId, String accountNo, TradeDirection direction,
