...
import io.github.navms.infrastructure.bank.converter.BalanceFlowConverter;
import io.github.navms.infrastructure.bank.mapper.BalanceFlowMapper;
...
public class BalanceFlowRepositoryImpl implements BalanceFlowRepository {
    ...
    @Override
    public List<BalanceFlow> query(String tenantId, String accountNo, LocalDate startDate, LocalDate endDate) {
