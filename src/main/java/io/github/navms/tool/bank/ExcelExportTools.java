...
public class ExcelExportTools {
    ...
    public String exportTradeDetailsExcel(
        ...
        return toJson(excelExportAppService.exportTradeDetails(
                new TradeDetailQuery(tenantId, accountNo, null, null, direction, startDate, endDate)));
    }
    ...
    public String exportAccountsExcel(
        ...
        return toJson(excelExportAppService.exportAccounts(new AccountQuery(tenantId, accountNo, accountName, status)));
    }
