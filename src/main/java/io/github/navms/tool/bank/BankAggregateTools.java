...
public class BankAggregateTools {
    ...
    public String summarizeTradeDetails(
        ...
        return toJson(bankAggregateAppService.summarizeTradeDetails(
    ...
    public String summarizePayOrders(
        ...
        return toJson(bankAggregateAppService.summarizePayOrders(
    ...
    public String summarizePayOrderDetails(
        ...
        return toJson(bankAggregateAppService.summarizePayOrderDetails(
                new BankAggregateQuery(tenantId, accountNo, null, status, startDate, endDate, groupBy)));
    }
    ...
    public String summarizeAccounts(
        ...
        return toJson(bankAggregateAppService.summarizeAccounts(
    ...
    public String summarizeElectronicReceipts(
        ...
        return toJson(bankAggregateAppService.summarizeReceipts(
    ...
    public String summarizeElectronicStatements(
        ...
        return toJson(bankAggregateAppService.summarizeStatements(
                new BankAggregateQuery(tenantId, accountNo, null, status, startDate, endDate, groupBy)));
    }
